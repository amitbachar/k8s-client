...
### RELEASE
helm upgrade -i k8s-client-python-release-v22.0.0 ../charts/k8s-client-python-v22.0.0.tgz --set version=relase-22,image.tag=latest,deployment.replicaCount=1,service.nodeport=32222
